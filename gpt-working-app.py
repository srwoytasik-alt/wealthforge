...
if "seeded" not in st.session_state:
    try:
        ...
        st.warning(f"Seed skipped: {str(e)}")
...
budget_doc = get_collection("budget").find_one()
...
elif budget_mode == "Full Budget (Post-June)":
    pass
...
page = st.sidebar.selectbox(
    "Navigation",
    ["Dashboard", "Transactions", "Debts & Assets", "Stability"]
)
...
st.sidebar.caption(
"WealthForge v1 • Personal Finance OS • Streamlit + MongoDB"
)